...
# 🔑 Разделяем ключ хранения и ключ виджета, чтобы обойти политику Streamlit
...
edited_df = st.data_editor(
    ...
    num_rows="dynamic",
    key=EDITOR_KEY  # Отличается от DATA_KEY
)
# Синхронизируем ручные правки обратно в хранилище
