...
def generate_groups(n: int, all_p: List[str], genders: Dict[str, str], 
                    ...
                    seed: Optional[int] = None, strict_r: bool = True, strict_g: bool = True, 
                    max_att: int = 500, workers: int = 0) -> GroupingResult:
